...
@Component({
    selector: 'inline-textarea-edit',
    templateUrl: 'app/shared/modules/inline-edits/inline-textarea-edit/inline-textarea-edit.component.html',
    providers: [
        {
            provide: NG_VALUE_ACCESSOR,
            useExisting: forwardRef(() => InlineTextareaEditComponent),
            multi: true
        }
    ]
})
export class InlineTextareaEditComponent implements ControlValueAccessor, OnInit {

    /** input control **/
    @ViewChild('inlineTextareaEditComponent') inlineTextareaEditComponent: ElementRef;
